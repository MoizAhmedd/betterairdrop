...
/// The Anthropic API key stored by `betterairdrop auth claude`, as a generic password in the login
/// keychain. The key is never written anywhere else.
public enum Keychain {
    public static let service = "dev.betterairdrop.anthropic"
    ...
    public static func storeAPIKey(_ key: String) throws {
        ...
        let add: [CFString: Any] = [
            kSecClass: kSecClassGenericPassword, kSecAttrService: service, kSecAttrAccount: account,
            kSecAttrLabel: "BetterAirdrop: Anthropic API key", kSecValueData: Data(key.utf8),
        ]
