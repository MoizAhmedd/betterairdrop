// Packs a GeoNames dump (cities15000.txt) into airname's binary city table.
// Usage: airname-pack-cities <cities15000.txt> <out.bin>
import AirnameCore
import Foundation

let args = CommandLine.arguments
guard args.count == 3 else {
    FileHandle.standardError.write(Data("usage: airname-pack-cities <cities15000.txt> <out.bin>\n".utf8))
    exit(2)
}
